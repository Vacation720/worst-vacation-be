...
app.post('/api/detail-page', async(req, res) =>  {
  try {
    ...
    RETURNING *
    `, [newTrip.city, newTrip.category, newTrip.business_type, newTrip.business_name, newTrip.review, newTrip.rating, newTrip.image_url, newTrip.trip_id, newTrip.address, req.userId]);
